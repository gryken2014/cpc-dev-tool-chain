...
GENHS=$(patsubst %.s,%.generated_from_asm_exported_symbols.h,$(SRSS))
#$(RELSC): $(GENHS)
...
%.generated_from_asm_exported_symbols.h %.rel: %.s Makefile $(CDTC_ENV_FOR_SDCC) cdtc_project.conf $(TARGETS_TO_BUILD_BEFORE_CDTC_S_TO_REL_STEP)
	...
	echo "// $<" ; \
	echo ; \
	echo "#ifndef access_asm_constant_as_pointer_to_type" ; \
	echo "#define access_asm_constant_as_pointer_to_type(ASMLABEL, TYPE)          \\" ; \
        echo "const TYPE *ASMCONST_ ## ASMLABEL ## _as_ ## TYPE ## _p = (( TYPE *) ASMCONST_ ## ASMLABEL )" ; \
...
astyle:
	...
	@echo "Modifs: "
	( for a in $(HDRS) $(SRCS) ; do echo -n $$a ; [[ -r $${a}.orig ]] || continue ; diff -u $${a}.orig $$a && echo " inchangé" ; rm -f $${a}.orig ; done ; exit 0 ; )
